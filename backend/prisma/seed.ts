...
async function main() {
  ...
  if (!existingOwner) {
    ...
    console.log('Owner account already exists:', existingOwner.name);
  }
  ...
  console.log('Categories seeded / upserted successfully.');
  ...
  console.log(`Successfully seeded / verified ${categoryNames.length} categories, ${itemsCount} menu items, and ${variantsCount} variants.`);
  console.log(`Total seed execution time: ${executionTime}ms`);
